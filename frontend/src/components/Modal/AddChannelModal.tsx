...
import { AddChannelModalProps } from './types';

const AddChannelModal: FunctionComponent<AddChannelModalProps> = ({ handleClose, isOpen }) => {
  const dispatch = useDispatch<AppDispatch>();
  const { t } = useTranslation();
  const { addChannelSocket } = useContext<ISocketActions>(ChatApiContext);
